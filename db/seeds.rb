...
UserDoWorkout.create(user_id: user4.id, workout_id: workout3.id)
UserDoWorkout.create(user_id: user5.id, workout_id: workout3.id)
UserDoWorkout.create(user_id: user6.id, workout_id: workout4.id)
UserDoWorkout.create(user_id: user7.id, workout_id: workout4.id)
UserDoWorkout.create(user_id: user8.id, workout_id: workout2.id)
UserDoWorkout.create(user_id: user9.id, workout_id: workout5.id)
UserDoWorkout.create(user_id: user10.id, workout_id: workout3.id)
UserDoWorkout.create(user_id: user5.id, workout_id: workout2.id)
UserDoWorkout.create(user_id: user11.id, workout_id: workout4.id)
UserDoWorkout.create(user_id: user10.id, workout_id: workout4.id)
UserDoWorkout.create(user_id: user16.id, workout_id: workout5.id)
UserDoWorkout.create(user_id: user15.id, workout_id: workout5.id)
